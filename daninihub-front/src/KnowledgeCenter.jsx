...
import TransportDocumentsArticle from './TransportDocumentsArticle'
import { deviationEscalationArticlePaths, driverCommunicationArticlePaths, etaArticlePaths, shiftHandoverArticlePaths, tmsArticlePaths, transportDocumentsArticlePaths } from './KnowledgePaths'
...
const editorial = {
  de: {
    ...
    published: [
      ...
      ['12 Min. Lesezeit · Dokumente', 'Transportdokumente übergeben: CMR, POD und offene Nachweise', 'Ein kontrollierter Statusfluss für Zuordnung, Qualitätsprüfung, berechtigte Empfänger, Datenschutz, Ablage und offene nächste Schritte.', transportDocumentsArticlePaths.de],
    ],
    ...
    planned: ['Abend- und Wochenenddisposition: klare Grenzen für externe Unterstützung', 'Statusqualität messen: fünf Kennzahlen für operative Transparenz'],
  },
  sr: {
    eyebrow: 'PRAKSA I ZNANJE · BALKAN–DACH', title: 'Operativno znanje za transportne timove.',
    lead: 'Stručni članci, kontrolne liste i praktični primeri o statusu, ETA, komunikaciji sa vozačima, dokumentima, eskalaciji i pouzdanoj predaji smene.',
    ...
    published: [
      ...
      ['12 min. čitanja · Dokumenta', 'Predaja transportnih dokumenata: CMR, POD i otvoreni dokazi', 'Kontrolisan tok statusa za povezivanje, proveru kvaliteta, ovlašćene primaoce, zaštitu podataka, arhivu i otvorene korake.', transportDocumentsArticlePaths.sr],
    ],
    ...
    planned: ['Večernja i vikend dispozicija: jasne granice spoljne podrške', 'Merenje kvaliteta statusa: pet pokazatelja operativne preglednosti'],
  },
}
