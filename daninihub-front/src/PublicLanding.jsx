...
const copy = {
  de: {
    ...
    startSteps: [['01', '20 Minuten Erstgespräch', 'Relationen, Fahrzeugzahl und tatsächlichen Engpass klären.'], ['02', 'Aufgaben und Befugnisse', 'Schriftlich festlegen, was übernommen, gemeldet oder eskaliert wird.'], ['03', 'Passenden Rahmen vereinbaren', 'Umfang, Erreichbarkeit, Vergütung und Auswertung vor dem Start verbindlich abstimmen.']],
  ...
  sr: {
    ...
    startSteps: [['01', 'Uvodni razgovor od 20 minuta', 'Razjašnjavamo relacije, broj vozila i stvarni operativni problem.'], ['02', 'Zadaci i ovlašćenja', 'Pismeno definišemo šta se preuzima, prijavljuje ili prosleđuje na odluku.'], ['03', 'Dogovor odgovarajućeg okvira', 'Pre početka usaglašavamo obim, dostupnost, naknadu i način evaluacije.']],
