...
const article = {
  de: {
    ...
    mandatory: [
      ...
      ['04', 'Abweichung und Auswirkung beschreiben', 'Benennen, was vom Plan abweicht und welches Risiko für Slot, Folgeauftrag, Dokumente oder Kunde entsteht.'],
  ...
  sr: {
    ...
    record: [
      ...
      ['Posledica', 'Slot za istovar je ugrožen; mogući čekanje i pomeranje naredne ture'],
    ...
    checks: [
      ...
      'Gde su kompletno sačuvani komunikacija, dokumenta i dokazi?',
    ],
