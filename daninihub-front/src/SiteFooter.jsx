...
export default function SiteFooter({ lang }) {
  ...
  return <footer className="site-footer-pro">
    ...
    <div className="site-footer-grid">
      <section className="site-footer-brand"><a className="site-footer-logo" href={home}><img src="/logo-mark.svg" alt=""/><span><strong>DaniniHub</strong><small>BUSINESS &amp; OPERATIONS</small></span></a><p>{t.about}</p><div className="footer-contact"><a href="mailto:info@daninihub.com">info@daninihub.com</a><a href="tel:+4915730916621">+49 1573 0916621</a><span>Duisburg · Deutschland</span><a href={sr ? 'https://calije.daninihub.com/sr' : 'https://calije.daninihub.com/de'}>Čalije Parking · Niš ↗</a></div></section>
