...
const article = {
  de: {
    ...
    related: [
      ...
      ['Warum TMS Disponenten nicht ersetzt', 'Warum eine gespeicherte Datei noch keine geprüfte operative Information ist.', 'Grundlagenartikel lesen', tmsArticlePaths.de],
    ],
    back: 'Praxis & Wissen',
  ...
  sr: {
    ...
    principleTitle: 'Dokument nije završen samo zato što fajl postoji.',
    ...
    risks: [
      ['POGREŠAN SLUČAJ', 'Dokument se povezuje sa turom samo preko naziva fajla ili istorije poruka; referenca, vozilo ili mesto isporuke nisu provereni.'],
    ...
    recordFields: [
      ...
      ['08', 'Mesto i verzija', 'Jedinstveno mesto čuvanja, naziv fajla, verzija i kontrola paralelnih kopija.'],
    ...
    example: [
      ...
      ['Prijem', '18:22 · sken vozača preko odobrenog kanala ture'],
      ...
      ['Odgovornost', 'Večernja dispozicija proverava pravilo klijenta; kod odbijanja eskalira definisanoj internoj ulozi'],
    ],
    goodReason: 'Zapis razdvaja postojeći fajl, rezultat provere, ugovoreni POD zahtev i otvorenu odluku.',
    ...
    privacyText: 'Imena, potpisi, brojevi telefona, registarske oznake ili podaci vozača ne smeju se nekontrolisano deliti. Za svaku obradu rukovalac mora imati odgovarajući pravni osnov; saglasnost nije automatski uvek neophodna niti je uvek pravi osnov. Operativno su važni ograničenje svrhe, minimizacija podataka, ograničen pristup, bezbedan prenos, definisano čuvanje i proverljivo brisanje. Privatni četovi i nekontrolisane kopije ne treba da postanu arhiva dokumenata.',
    ...
    related: [
      ...
      ['Zašto TMS ne menja disponente', 'Zašto sačuvan fajl još nije proverena operativna informacija.', 'Pročitaj osnovni članak', tmsArticlePaths.sr],
    ],
