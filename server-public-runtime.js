...
function home(lang){
  ...
  '<main class="wrap">'+
  '<section class="hero"><div><p class="eyebrow">'+(sr?'PRE KUPOVINE PROVERI RAČUNICU I AUTO':'ALLES PRÜFEN, BEVOR DU ZAHLST')+'</p><h1>'+(sr?'Uvoz auta iz Nemačke u Srbiju, bez neprijatnih iznenađenja.':'Auto aus Deutschland oder der Schweiz? Erst prüfen, dann kaufen.')+'</h1><p class="lead">'+(sr?'Izračunaj okviran trošak uvoza pre kupovine. Ako ti treba pomoć, pošalji oglas: možeš zatražiti obilazak auta, proveru dokumenata ili ponudu za dovoz. Uključena je i Švajcarska.':'Auf einer Seite siehst du Gesamtkosten, Herkunfts- und Dokumentenrisiko, bekannte Modellschwächen sowie Optionen für Prüfung, Teile und Überführung.')+'</p><div class="hero-actions"><a class="btn" href="#passport">'+(sr?'Izračunaj trošak uvoza':'Konkretes Auto prüfen')+'</a><a class="btn secondary" href="#service-request">'+(sr?'Pošalji oglas i zatraži pomoć':'Service anfragen')+'</a></div><div class="trust"><span>'+(sr?'Početna računica je besplatna':'Kostenloser Erstcheck')+'</span><span>'+(sr?'Cena usluge se potvrđuje unapred':'Vollreport 9,90 €')+'</span></div></div><div class="hero-visual"><img src="/pregled-polovnog-automobila.webp" width="1696" height="943" alt="'+(sr?'Pregled polovnog automobila pre kupovine':'Gebrauchtwagenprüfung vor dem Kauf')+'"></div></section>'+
