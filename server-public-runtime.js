...
function mountPublicRuntime(app) {
  ...
  const siteRoutes = [
    '/', '/de', '/de/', '/sr', '/sr/',
    '/de/impressum', '/de/datenschutz', '/de/cookies', '/de/haftungsausschluss', '/de/praxis-wissen', '/de/glossar',
    '/sr/impressum', '/sr/privatnost', '/sr/kolacici', '/sr/odricanje-odgovornosti', '/sr/praksa-propisi', '/sr/recnik'
  ];
  ...
  app.get('/sitemap.xml', (req, res) => res.type('application/xml').send(
    ...
    ['/de/','/sr/','/de/impressum','/de/datenschutz','/de/cookies','/de/haftungsausschluss','/de/praxis-wissen','/de/glossar','/sr/impressum','/sr/privatnost','/sr/kolacici','/sr/odricanje-odgovornosti','/sr/praksa-propisi','/sr/recnik'].map(route => `<url><loc>https://daninihub.com${route}</loc></url>`).join('') +
    '</urlset>'
  ));
